...
ROLE_ARN = "arn:aws:iam::908027394331:role/sagemaker-execution-role"
PROCESSED_BUCKET = "fraud-processed"
MODEL_BUCKET = "fraud-model-store"
DEPS_BUCKET = "pipeline-deps"

script_processor = ScriptProcessor(
    image_uri="908027394331.dkr.ecr.us-east-1.amazonaws.com/fraud-pipeline", # TODO: update it with custom image
    command=["python3"],
